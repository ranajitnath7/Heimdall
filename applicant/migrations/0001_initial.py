    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('religion', models.CharField(choices=[('Islam', 'Islam'), ('Hinduism', 'Hinduism'), ('Cristian', 'Cristian'), ('Buddhist', 'Buddhist')], max_length=10)),
                ('blood_group', models.CharField(max_length=20)),
                ('freedom_fighter_quota', models.CharField(choices=[('No', 'No'), ('Yes', 'Yes')], default='0', max_length=150)),
                ('is_autism', models.CharField(choices=[('No', 'No'), ('Yes', 'Yes')], default='0', max_length=150)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('exam_name', models.CharField(choices=[('SSC', 'SSC'), ('HSC', 'HSC')], max_length=10)),
                ('board_name', models.CharField(choices=[('Kolkata', 'Kolkata'), ('Khulna', 'Khulna'), ('Rajshahi', 'Rajshahi'), ('Rajshahi', 'Rajshahi'), ('Jessore', 'Jessore'), ('Comilla', 'Comilla')], max_length=10)),
